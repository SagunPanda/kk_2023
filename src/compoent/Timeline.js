    ...
    <>
      <section className="timeline" id="timeline">
        ...
        <div className="right-end-side">
          <div className="time">
            <div className="row">
              <div className="image-dot image-dot-july">
                <img className="start-img" src={start} alt="start" />
                <img className="darkline" src={darkline} alt="line" />
              </div>
              <div className="month-content month-content-july">
                <h1>JULY </h1>
                <div className="content july-content">
          ...
          <div className="time">
            <div className="row-n">
              <div className="image-dot img-dot-nov">
                <img className="Ellipse2" src={Ellipse2} alt="Ellipse" />
                <img className="lightline" src={lightline} alt="line" />
              </div>
              <div className="month-content-n">
